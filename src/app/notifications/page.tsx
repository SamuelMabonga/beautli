        ...
        <main className="flex min-h-screen  max-w-screen overflow-hidden flex-col sm:items-center">
            ...
            <div className="md:border-x-[1px] border-gray-200 w-full sm:w-3/4 md:w-2/3 lg:w-1/2 min-h-screen">
                ...
                <div className="flex justify-between p-4 pt-8" >
                    <h6 className="font-medium text-xl md:text-2xl my-auto">Notifications</h6>
                    <Select defaultValue='personal'>
                        <SelectTrigger className="w-[180px] text-sm md:text-base border-0 outline-none flex gap-0">
                            <SelectValue className='text-sm md:text-base'  />

                            <Badge variant="outline" className="w-fit h-fit bg-[#CC0087] text-white font-medium">20</Badge>
                        </SelectTrigger>
                        <SelectContent>
                ...
                <div className="p-4 md:p-8 flex flex-col bg-[#F4F4F4]">
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col my-auto">
                            ...
                            <p className="text-gray-500 text-sm md:text-base">$500 <span className="h-full w-[1px] bg-black" /> <span>For June 20th, 2023</span></p>
                ...
                <div className="flex flex-col p-4 md:p-8 bg-[#F4F4F4]">
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="text-gray-500 text-sm md:text-base" >$50 <span className="h-full w-[1px] bg-black" /> <span>For June 20th, 2023</span></p>
                ...
                <div className="flex flex-col p-4 md:p-8">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="flex gap-2 text-sm md:text-base">
                            ...
                            <span className="font-medium my-auto">$70 charged</span>
                        </p>
                ...
                <div className="p-4 md:p-8 flex flex-col ">
                    <div className="flex gap-4">
                        ...
                        <div className="flex flex-col my-auto">
                            ...
                            <p className='text-sm md:text-base'>$350 <span className="h-full w-[1px] bg-black" /> <span className='text-gray-500'>For June 20th, 2023</span></p>
